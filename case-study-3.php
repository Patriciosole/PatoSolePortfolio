...
<body class="bg-white text-slate-800 font-sans antialiased">
  ...
  <section class="reveal bg-[#fdfcfb]" aria-labelledby="hero-title">
    <div class="max-w-7xl mx-auto py-8">
      ...
      <div class="relative w-full -mb-1 md:h-[450px] overflow-hidden shadow-2xl bg-cover bg-left md:bg-center bg-no-repeat flex items-center border-8 border-white rounded-xl" style="background-image: url('assets/images/sections/case-studies/C3/main.jpg');">
        <div class="mb-6 mt-6 md:mt-0 md:mb-12 ml-12">
          <h1 id="hero-title" class="text-5xl md:text-7xl font-extrabold text-slate-900 mb-2 drop-shadow-[0_0_15px_rgba(255,255,255,1)]">Brokers</h1>
          ...
          <p class="text-lg text-slate-400 font-medium mb-8 leading-relaxed bg-white px-4 py-2 rounded-3xl shadow-sm border border-slate-50 mt-4 w-fit">
            Product Design <span class="mx-2 text-slate-300">•</span> Real Estate Valuation Platform
          </p>
  ...
  <section class="reveal py-12" aria-labelledby="tools-heading">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="flex flex-wrap justify-center gap-8 md:gap-16">
        ...
        <!-- Python/AI -->
        <div class="flex flex-col items-center gap-2 group">
          <div class="w-12 h-12 rounded-full bg-blue-500 flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform" aria-hidden="true">
            <svg class="w-6 h-6" viewBox="0 0 24 24" aria-hidden="true">
              <text x="50%" y="50%" dominant-baseline="central" text-anchor="middle" class="fill-white text-[10px] font-bold">PY</text>
            </svg>
          </div>
        ...
        <!-- React -->
        <div class="flex flex-col items-center gap-2 group">
          <div class="w-12 h-12 rounded-full bg-cyan-500 flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform" aria-hidden="true">
            <svg class="w-6 h-6 fill-white" viewBox="0 0 24 24" aria-hidden="true">
              <path d="M12 0c6.627 0 12 5.373 12 12s-5.373 12-12 12S0 18.627 0 12 5.373 0 12 0zm0 2.25c-5.385 0-9.75 4.365-9.75 9.75s4.365 9.75 9.75 9.75 9.75-4.365 9.75-9.75S17.385 2.25 12 2.25zm0 4.5c2.485 0 4.5 2.015 4.5 4.5s-2.015 4.5-4.5 4.5-4.5-2.015-4.5-4.5 2.015-4.5 4.5-4.5zm0 2.25c-1.243 0-2.25 1.007-2.25 2.25s1.007 2.25 2.25 2.25 2.25-1.007 2.25-2.25-1.007-2.25-2.25-2.25z"/>
            </svg>
          </div>
        ...
        <!-- Node.js -->
        <div class="flex flex-col items-center gap-2 group">
          <div class="w-12 h-12 rounded-full bg-green-500 flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform" aria-hidden="true">
            <svg class="w-6 h-6 fill-white" viewBox="0 0 24 24" aria-hidden="true">
              <path d="M12.001 0l-10.5 6.062v12.125l10.5 6.062 10.5-6.062V6.062L12.001 0zm0 2.187l8.25 4.763v9.875l-8.25 4.763-8.25-4.763V6.95l8.25-4.763zm0 3.563l-5.25 3.031v6.063l5.25 3.031 5.25-3.031V8.781l-5.25-3.031z"/>
            </svg>
          </div>
        ...
        <!-- Database -->
        <div class="flex flex-col items-center gap-2 group">
          <div class="w-12 h-12 rounded-full bg-slate-600 flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform" aria-hidden="true">
            <svg class="w-6 h-6 fill-white" viewBox="0 0 24 24" aria-hidden="true">
              <path d="M12 2C6.48 2 2 4.02 2 6.5v11C2 19.98 6.48 22 12 22s10-2.02 10-4.5v-11C22 4.02 17.52 2 12 2zm0 2c4.42 0 8 1.12 8 2.5S16.42 9 12 9 4 7.88 4 6.5 7.58 4 12 4zm0 12c-4.42 0-8-1.12-8-2.5V13c0 1.38 3.58 2.5 8 2.5s8-1.12 8-2.5v.5c0 1.38-3.58 2.5-8 2.5zm0-4c-4.42 0-8-1.12-8-2.5V9c0 1.38 3.58 2.5 8 2.5s8-1.12 8-2.5v.5c0 1.38-3.58 2.5-8 2.5z"/>
            </svg>
          </div>
      ...
      <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="reveal">
          ...
          <div class="bg-slate-50 p-8 md:p-12 rounded-2xl border border-neutral-200 leading-relaxed text-slate-600 space-y-6">
            ...
            <p class="pt-4 border-t border-slate-200">This was an end-to-end project where I handled both design and development.</p>
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="reveal mb-16">
          ...
          <div class="grid md:grid-cols-2 gap-8 mb-12">
            <div class="space-y-4">
              <img alt="Brokers property valuation interface showing address input and estimated value" class="rounded-xl shadow-lg w-full border-8 border-white" src="assets/images/sections/case-studies/C3/DP1.jpg" />
              <p class="text-slate-400 text-sm italic mt-2">Login Screen.</p>
            </div>
            <div class="space-y-4">
              <img alt="Lead management dashboard for real estate brokers" class="rounded-xl shadow-lg w-full border-8 border-white" src="assets/images/sections/case-studies/C3/DP2.jpg" />
              <p class="text-slate-400 text-sm italic mt-2">AI Prompt editor view. Here you can manage the way the ChatGPT API will work.</p>
            </div>
          </div>
          ...
          <div class="grid md:grid-cols-2 gap-8 my-12">
            <div class="space-y-4">
              <img alt="Brokers property valuation interface showing address input and estimated value" class="rounded-xl shadow-lg w-full border-8 border-white mt-2" src="assets/images/sections/case-studies/C3/DP3.jpg" />
              <p class="text-slate-400 text-sm italic mt-2">Dashboard Screen</p>
            </div>
            <div class="space-y-4">
              <img alt="Lead management dashboard for real estate brokers" class="rounded-xl shadow-lg w-full border-8 border-white" src="assets/images/sections/case-studies/C3/DP4.jpg" />
              <p class="text-slate-400 text-sm italic mt-2">Three stages of the user form, when closed, the first stage and the success one..</p>
            </div>
          </div>
        </div>
      </div>
            ...
            <div class="grid lg:grid-cols-2 gap-16">
              <div class="space-y-10">
                <div>
                  ...
                  <ul class="space-y-6">
                    <li>
                      <p class="font-bold text-slate-900">AI Property Valuation</p>
                      <p class="text-slate-500">Instant property estimates using machine learning models trained on market data.</p>
                    </li>
                    <li>
                      <p class="font-bold text-slate-900">Lead Capture System</p>
                      <p class="text-slate-500">Smart forms that capture owner details while delivering valuation results.</p>
                    </li>
                    <li>
                      <p class="font-bold text-slate-900">Broker Dashboard</p>
                      <p class="text-slate-500">Comprehensive lead management with filtering, sorting, and contact tools.</p>
                    </li>
                  </ul>
                </div>
              </div>
              <div class="space-y-10">
                ...
                <div>
                  ...
                  <p class="text-slate-600 mb-2 font-bold">Property Owners</p>
                  <p class="text-slate-500 mb-4">Homeowners and property investors seeking quick, accurate valuations.</p>
                  <p class="text-slate-600 mb-2 font-bold">Real Estate Brokers</p>
                  <p class="text-slate-500">Professionals looking for pre-qualified leads with property information.</p>
                </div>
              </div>
            </div>
            <div class="mt-20 pt-20 border-t border-slate-200 text-center">
              ...
              <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="text-center">
                  <div class="text-5xl font-black text-brand-600 mb-2">500+</div>
                  <div class="text-xs uppercase font-bold text-slate-400 tracking-wider">Valuations first month</div>
                </div>
                <div class="text-center">
                  <div class="text-5xl font-black text-brand-600 mb-2">35%</div>
                  <div class="text-xs uppercase font-bold text-slate-400 tracking-wider">Lead conversion rate</div>
                </div>
                <div class="text-center">
                  <div class="text-5xl font-black text-brand-600 mb-2">40%</div>
                  <div class="text-xs uppercase font-bold text-slate-400 tracking-wider">Acquisition cost reduction</div>
                </div>
              </div>
            </div>
          </div>
    ...
    <section class="reveal" aria-label="Project showcase image">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="reveal rounded-3xl overflow-hidden shadow-2xl border border-neutral-200">
          <img alt="Brokers platform shown on multiple devices with responsive design" class="w-full object-cover" src="assets/images/sections/case-studies/C3/end.jpg" />
        </div>
      </div>
    </section>
    <!-- END: FullWidthImage -->
